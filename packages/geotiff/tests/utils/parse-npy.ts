// Vendored from loaders.gl under the MIT license
// https://github.com/visgl/loaders.gl/blob/d85491705e9943365790fb95da2e502cb2903ed7/modules/textures/src/lib/parsers/parse-npy.ts
...
export function parseNPY(arrayBuffer: ArrayBuffer): NPYTile {
  ...
  const data = new ArrayType(
    arrayBuffer.slice(headerEndOffset, headerEndOffset + arrayByteLength),
  );

  // Swap endianness if needed
  if (
    (numpyType[0] === ">" && LITTLE_ENDIAN_OS) ||
    (numpyType[0] === "<" && !LITTLE_ENDIAN_OS)
  ) {
